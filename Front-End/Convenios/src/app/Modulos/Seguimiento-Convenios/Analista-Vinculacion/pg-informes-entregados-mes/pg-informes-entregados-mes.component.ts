...
@Component({
  selector: 'app-pg-informes-entregados-mes',
  templateUrl: './pg-informes-entregados-mes.component.html',
  styleUrls: ['./pg-informes-entregados-mes.component.css'],
  providers:[MessageService]
})
export class PgInformesEntregadosMesComponent {
  ...
  opcionesEvaluacion = ['Pendiente','Validado'];
  ...
  listarInformes(){
    this.informeService.getInformesMes().subscribe(
      informe=>{
