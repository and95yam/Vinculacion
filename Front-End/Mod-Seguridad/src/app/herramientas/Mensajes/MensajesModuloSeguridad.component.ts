...
export class MensajesModuloSeguridad {
    ...
    ErrorFormatoArchivo:string='Formato encabezado del archivo incorrecto.';
    ErrorestadoCronograma:string='No se puede agregar actividades cronograma inactivo.';
